 ...
 * @param {Float32Array} time_series
 * @returns {Float32Array}
 */
export function compute_fft(time_series) {
    const ptr0 = passArrayF32ToWasm0(time_series, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compute_fft(ptr0, len0);
 ...
 * @returns {Float32Array}
 */
export function compute_fft_magnitude(time_series) {
    const ptr0 = passArrayF32ToWasm0(time_series, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compute_fft_magnitude(ptr0, len0);
    var v2 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v2;
}
 ...
 * @returns {Float32Array}
 */
export function compute_fft_magnitude_from_string(file_content) {
    const ptr0 = passStringToWasm0(file_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compute_fft_magnitude_from_string(ptr0, len0);
    var v2 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v2;
}
 ...
 * @returns {Float32Array}
 */
export function parse_time_series_from_string(file_content) {
    const ptr0 = passStringToWasm0(file_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_time_series_from_string(ptr0, len0);
    var v2 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v2;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rs_wasm_experiment_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
